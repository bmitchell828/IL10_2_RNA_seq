...
png(filename="DESeq_output/DESeq_sampleCorr_IEC_laptop.png", units = 'in', width = 10, height = 10, res = 250)
...
png(filename="DESeq_output/DESeq_sampleCorr_INT_laptop.png", units = 'in', width = 10, height = 10, res = 250)
...
png(filename="DESeq_output/DESeq_sampleDist_IEC_laptop.png", units = 'in', width = 10, height = 10, res = 250)
...
png(filename="DESeq_output/DESeq_sampleDist_INT_laptop.png", units = 'in', width = 10, height = 10, res = 250)
pheatmap(sampleDistMatrix,
         clustering_distance_rows=sampleDists,
         clustering_distance_cols=sampleDists,
         annotation = treat_ann_INT,
...
png('DESeq_output\\DESeq_PCA_IEC_laptop.png', units='in', width=7, height=5, res=250)
...
png('DESeq_output/DESeq_PCA_INT_laptop.png', units='in', width=7, height=5, res=250)
ggplot(data, aes(PC1, PC2, color=Condition)) +
  geom_point(size=4, alpha = 0.85) +
  geom_text_repel(aes(label=name)) +
  theme_bw() +
